"""Tests for tradeval.discover: sector/theme resolution and earnings-candidate scan.
...
from tradeval import discover
from tradeval.discover import Candidate, SectorCompany
...
def test_sector_companies_theme_uses_company_snapshots():
    ...
    with patch("tradeval.discover.company_snapshots", return_value=snapshots):
