"""Tests for tradeval.graph: drawing counterparties as a terminal graph."""

from __future__ import annotations

from tradeval import graph
from tradeval.relationships import CUSTOMER, RIVAL, SUPPLIER, Link
