"""Tests for tradeval.relationships: the hand-maintained counterparty edges."""

from __future__ import annotations

import pytest

from tradeval import relationships as rel
from tradeval.relationships import CUSTOMER, RIVAL, SUPPLIER
