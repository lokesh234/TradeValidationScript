"""Tests for tradeval.upside: what a market cap you believe in would pay."""

from __future__ import annotations

import pytest

from tradeval import upside
from tradeval.upside import Projection, annual_rate, format_cap, parse_cap
