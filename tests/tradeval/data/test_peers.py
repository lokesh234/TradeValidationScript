"""Tests for tradeval.data.peers: earnings read-across from industry peers."""
...
from tradeval.data.peers import PeerReport, average_move, average_surprise, peers_already_reported
...
def test_peers_already_reported_empty_without_industry_peers():
    with patch("tradeval.data.peers.industry_peers", return_value=[]):
